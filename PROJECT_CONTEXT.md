...
> 最后更新：2026-09-24｜扩展 3.7.7（源码；Ego 待重载）｜DeepSeek 新 Key 已接入 Worker｜路线：Neon 执行账本 + R2 证据 + 本地字段优先、AI 补全
